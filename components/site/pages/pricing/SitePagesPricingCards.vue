          ...
          >
            ...
            >
              <div class="bg-white px-6 py-8 sm:p-10 sm:pb-6">
                <div>
                  <h3
                    class="inline-flex rounded-full bg-indigo-100 px-4 py-1 text-base font-semibold text-indigo-600"
                    id="tier-standard"
                  >
                    {{ tier.name }}
                  </h3>
                ...
                <div
                  class="mt-4 flex items-baseline text-6xl font-bold tracking-tight"
                >
                  ${{ tier.priceMonthly }}
                  <span
                    class="ml-1 text-2xl font-medium tracking-normal text-gray-500"
                    >/mo</span
                  >
                </div>
